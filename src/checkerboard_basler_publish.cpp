...
double tx_ini,ty_ini,tz_ini,rx_ini,ry_ini,rz_ini, rw_ini;
double PI = 3.14159;
std::string frame_a;
std::string frame_b;
...
int main(int argc, char** argv){
  ...
  home.getParam("rw_launch", rw_ini);
  ...
  tf::Quaternion q(rx_ini, ry_ini, rz_ini, rw_ini);
  transform.setRotation(q);
  transform.getBasis().getRPY(rx_ini, ry_ini, rz_ini);
